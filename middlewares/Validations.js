...
const validations = [
    ...
    body('pass').notEmpty().withMessage('Debes digitar una contraseña').bail().matches('(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[^A-Za-z0-9])(?=.{8,})').withMessage('Contraseña no cumple con los requerimientos de seuridad. Debe tener almenos una letra en minúscula, una en mayúscula, un número y un carácter especial como @ o #, y debe ser de almenos 8 caracteres. '),
